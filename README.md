...
e.g. a research project lead by a Team composed from 3 directions: CEFEB,DOE,ERS will end up being 4 bilaterals collaborations 
(CEFEB,DOE),  (CEFEB,ERS), (DOE, ERS)

The data is available in a text file in this repository

Here is the resulting data viz:
HTML('<iframe src="networkchart.html" scrolling="no" frameborder="0" width="100%" height="900px"></iframe>')
